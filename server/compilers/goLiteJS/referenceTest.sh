...
VALID_DIR=./src/test/ml2/valid/*.go
...
do
	...
	~cs520/golitec typecheck $PROG 2>&1 | tee -a valid.log | tr -d '\n'
...
INVALID_DIR=./src/test/ml2/invalid/*.go
...
do
	...
	~cs520/golitec typecheck $PROG 2>&1 | tee -a invalid.log | tr -d '\n'
